...
def get_model(model_config: ModelConfig,
    ...
    if is_openvino_optimum_intel():
        ...
        pt_model.memory_statistics = core.get_property(ov_device, intel_gpu.memory_statistics)
        pt_model.device_total_mem_size = core.get_property(ov_device, intel_gpu.device_total_mem_size)
